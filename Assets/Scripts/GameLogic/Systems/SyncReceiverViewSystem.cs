...
{
    public class SyncReceiverViewSystem : IEcsInitSystem, IEcsRunSystem
    {
        private const float ITEM_SIZE = 2f; // ВЫНЕСТИ В КФГ
        
        private readonly IAmmoReceiverViewFactory _ammoReceiverViewFactory;
        ...
        public SyncReceiverViewSystem(IAmmoReceiverViewFactory ammoReceiverViewFactory,
            IItemViewFactory itemViewFactory)
        {
            _ammoReceiverViewFactory = ammoReceiverViewFactory;
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            {
                if (!_ammoReceiverViewFactory.TryGetView(entityId, out var view))
                {
                    view = _ammoReceiverViewFactory.CreateView(entityId);
                }
